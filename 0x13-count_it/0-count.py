#!/usr/bin/python3
"""
count the number of words in the Reddit API Model
"""
import requests


def count_words(sub, word_list, count={}, after=""):
    """
    ...
    url = "https://api.reddit.com/r/{}/hot".format(sub)
    ...
    count_words(sub, word_list, count, after)
